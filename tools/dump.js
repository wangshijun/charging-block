...
(async () => {
  ...
  console.log(`moderator pk base64: ${base64.escape(base64.encode(ForgeSDK.Util.hexToBytes(json.pk)))}`);

  // const res = await ForgeSDK.getAccountState({ address: moderator.address x});
})();
